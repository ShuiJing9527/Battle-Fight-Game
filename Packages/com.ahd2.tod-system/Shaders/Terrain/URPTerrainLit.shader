Shader "AHD2TODSystem/URPTerrainLit"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/AHD2-TODSystem/Shaders/Terrain/TerrainLitInput.hlsl"
            #include "Packages/AHD2-TODSystem/Shaders/Terrain/TerrainLitPass.hlsl"
            ENDHLSL
        }
